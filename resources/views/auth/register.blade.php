...
<div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
    <div class="bg-white text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 py-10 px-10 items-center text-white" style="background: rgb(38,152,139); background: linear-gradient(0deg, rgba(38,152,139,1) 0%, rgba(108,207,92,1) 100%);">
                ...
                {{-- <img class="w-full self-center" src="{{ asset('storage/image/registration-page-4.jpg') }}" /> --}}
                <div class="font-bold text-2xl">Welcome Back!</div>
                <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus nisl sit amet suscipit mollis. </div>
            </div>
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-800">Create Account</h1>
