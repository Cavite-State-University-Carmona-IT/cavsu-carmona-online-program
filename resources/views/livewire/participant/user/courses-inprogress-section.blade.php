<div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mt-12 mb-12 bg-transparent">
        <article>
            <h2 class="text-2xl text-gray-900">In Progress</h2>
            <section class="mt-6 grid grid-cols-4 grid-rows-1 gap-4">
