        ...
        <div class="fixed inset-y-0 flex flex-shrink-0 transition-all">
            ...
            <nav aria-label="Options" class="fixed inset-x-0 bottom-0 flex flex-row-reverse items-center justify-between px-4 py-2 bg-white border-t border-green-100 sm:hidden shadow-t rounded-t-3xl">
                ...
                <button
                    ...
                    class="p-2 transition-colors rounded-lg shadow-md text-gray-500 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-300 focus:ring-offset-white focus:ring-offset-2"
                    :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-gray-500' : 'text-white-500 bg-white'"
                    >
                    <span class="sr-only">Toggle sidebar</span>
                    <i class="fas fa-stream w-6 h-auto"></i>
                </button>

                <!-- Logo -->
                <a href="#">
                    <img class="h-7 w-7 self-center" src="{{ asset('storage/image/cvsu-ext-application-logo.png') }}" />
                </a>
            ...
            <!-- Left mini bar -->
            <nav aria-label="Options" class=" z-20 flex-col items-center flex-shrink-0 hidden w-16 py-4 bg-white border-r-1 border-gray-200 shadow-md sm:flex" > <!-- rounded-tr-3xl rounded-br-3xl -->
                <!-- Logo -->
                <div class="flex-shrink-0 py-4">
                    <a href="{{ url('/') }}">
                        <img class="h-auto w-10 self-center" src="{{ asset('storage/image/cvsu-ext-application-logo.png') }}" />
                    </a>
                </div>
                <div class="flex flex-col items-center flex-1 p-2 space-y-4">
                    ...
                    <button @click="(isSidebarOpen && currentSidebarTab == 'messagesTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'messagesTab'"
                        ...
                        <i class="fas fa-inbox w-6 h-auto"></i>
                    </button>
                    ...
                    <button @click="(isSidebarOpen && currentSidebarTab == 'notificationsTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'notificationsTab'"
                        ...
                        <i class="fas fa-bell w-6 h-auto"></i>
                    </button>
                </div>
            ...
            <div
                ...
                <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
                    ...
                    <div class="flex items-center justify-center flex-shrink-0 py-10">
                        <a href="{{ url('/') }}">
                            <img class="h-auto w-24 self-center" src="{{ asset('storage/image/cvsu-ext-application-logo.png') }}" />
                        </a>
                    </div>
                    ...
                    <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto text-sm tracking-wider text-gray-500 font-semibold">
                        ...
                        <a href="{{ route('program-coordinator.advertisement') }}" class="flex items-center w-full space-x-2  p-2  border-l-2 border-transparent ">
        ...
        <div class="flex flex-col flex-1">
            <header class="relative flex items-center justify-between flex-shrink-0 p-4">
                ...
                <div class="items-center hidden ml-4 sm:flex">
                    ...
                    class="p-2 transition-colors rounded-lg shadow-md text-gray-500 bg-white hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-300 focus:ring-offset-white focus:ring-offset-2"
                    ...
                    <i class="fas fa-cog w-6 h-auto"></i>
                    </button>
                </div>
                ...
                <div class="flex flex-row-reverse">
                    <button
                        ...
                        class="sm:hidden fixed bg-white right-2 mx-1 p-2 transition-colors rounded-lg shadow-md text-gray-500 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-300 focus:ring-offset-white focus:ring-offset-2"
                        ...
                        >
                        <span class="sr-only">Toggle message panel</span>
                        <i class="fas fa-angle-left w-6 h-auto"></i>
                    </button>
                    <div class="fixed mr-12">
                        ...
                        <button
                            ...
                            class="mx-1 p-2 bg-white sm:hidden transition-colors rounded-lg shadow-md text-gray-500 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-300 focus:ring-offset-white focus:ring-offset-2"
